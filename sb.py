                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['yang tag sy semoga jomblo seumur hidup','ngapain tag tag woe, kangen?','ada apa ini? kAlau tag bayar.. ','duhh kena tag, dianya kesepian kali yah','gk usah tag, gift tikel aja']
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['eh ada','hai kak','Hayoo yg ngintip bintitan.. .','nah','lg ngapain','halo','sini kak']
